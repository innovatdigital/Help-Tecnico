...
db.once('open', function() {
  setInterval(async () => {
    ...
    for (const post of posts) {
      if (post.day == now.toLocaleDateString('pt-BR', {day: '2-digit', month: '2-digit', year: 'numeric'}) && post.hour == now.toLocaleTimeString([], {hour: '2-digit', minute:'2-digit', hour12: false})) {
